...
- Region capture: `Ctrl+Shift+S` by default
- Region capture freezes the screen first, preserving open browser menus and popups
- Full screen capture: `Ctrl+Shift+A` by default
